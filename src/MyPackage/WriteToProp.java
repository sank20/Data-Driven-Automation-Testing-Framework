	...
	try {
	 ...
	 public void WritePropertiesFile(String key, String data) {
	        ...
	        try {
	            ...
	            File file = new File("D:/Automation/Project/Data_Driven_Automation_Testing_Framework/src/MyPackage/Param.properties");
	            fileIn = new FileInputStream(file);
	            configProperty.load(fileIn);
	            configProperty.setProperty(key, data);
	            fileOut = new FileOutputStream(file);
	            configProperty.store(fileOut, "ENVIRONMENTAL VARIABLES");
